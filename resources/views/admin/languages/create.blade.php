                            ...
                            <form id="languageForm" action="{{ route('admin.languages.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror" 
                                           value="{{ old('code') }}" placeholder="ru, en, uk, de..." required maxlength="10">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" 
                                           value="{{ old('name') }}" placeholder="Русский, English, Українська..." required maxlength="100">
                                    @error('name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="locale" id="locale" class="form-control @error('locale') is-invalid @enderror"
                                           value="{{ old('locale') }}" placeholder="ru-RU, en-gb" required maxlength="255">
                                    @error('locale')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="directory" id="directory" class="form-control @error('directory') is-invalid @enderror"
                                           value="{{ old('directory') }}" maxlength="32" placeholder="ru-ru">
                                    @error('directory')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted d-block">Только активные языки будут отображаться в формах категорий.</small>
                                </div>
                            </form>
                        </div>
                    </div>
