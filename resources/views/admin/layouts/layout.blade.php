...
<head>
	...
	<link rel="stylesheet" href="{{ asset('assets/admin/css/myadmin.css') }}">
...
<div class="wrapper">
    ...
    <script src="{{ asset('assets/admin/js/myadmin.js') }}"></script>
        ...
        $('#ed').summernote({
            ...
            callbacks: {
                onImageUpload: function(files) {
                    ...
                    .then(data => {
                        $('#ed').summernote('insertImage', data.url);
                    })
